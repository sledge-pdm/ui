...
const themeColorVars = [
  ...
  '--color-shadow-top-light',
  '--color-shadow-bottom-shadow',
  '--color-shadow-drop',
  '--color-accent',
  '--color-active',
  '--color-enabled',
...
const baseDark: BuiltinThemeColors = {
  ...
  '--color-shadow-top-light': [255, 255, 255, 38],
  '--color-shadow-bottom-shadow': [0, 0, 0, 76],
  '--color-shadow-drop': [0, 0, 0, 128],
  ...
  '--color-modal-dialog-overlay': [0, 0, 0, 64],
  '--color-button-bg': [52, 52, 52, 255],
...
const builtinThemes: Record<Exclude<Theme, 'os'>, BuiltinThemeColors> = {
  light: {
    ...
    '--color-shadow-top-light': [255, 255, 255, 114],
    '--color-shadow-bottom-shadow': [0, 0, 0, 38],
    '--color-shadow-drop': [0, 0, 0, 30],
    ...
    '--color-modal-dialog-overlay': [255, 255, 255, 64],
    '--color-button-bg': [247, 247, 247, 255],
  ...
  black: {
    ...
    '--color-warn': [255, 251, 0, 255],
    '--color-modal-dialog-overlay': [0, 0, 0, 82],
    '--color-button-bg': [40, 40, 40, 255],
    '--color-button-hover': [68, 68, 68, 255],
    '--color-button-active': [85, 85, 85, 255],
    '--color-button-text': [238, 238, 238, 255],
